 ...
 */
    ...
    const xt = Math.PI, bt = 2 * xt, _t = bt + xt, yt = Number.POSITIVE_INFINITY, vt = xt / 180, Mt = xt / 2,
        wt = xt / 4, kt = 2 * xt / 3, St = Math.log10, Pt = Math.sign;
    ...
    function pe(t, e) {
        const {canvas: i, currentDevicePixelRatio: n} = e, o = de(i), s = "border-box" === o.boxSizing,
            a = ge(o, "padding"), r = ge(o, "border", "width"), {x: l, y: c, box: h} = function (t, e) {
    ...
    function xe(t, e, i, n) {
        const o = de(t), s = ge(o, "margin"), a = he(o.maxWidth, t, "clientWidth") || yt,
            r = he(o.maxHeight, t, "clientHeight") || yt, l = function (t, e, i) {
                let n, o;
    ...
    function je(t, e, i) {
        ...
        const s = Math.max(0, e.outerWidth - He(o, t, "left", "right")),
            a = Math.max(0, e.outerHeight - He(o, t, "top", "bottom")), r = s !== t.w, l = a !== t.h;
        ...
        addBox(t, e) {
            ...
            const o = Re(t.options.layout.padding), s = e - o.width, a = i - o.height, r = function (t) {
                const e = function (t) {
                        ...
                        return e
                    }(t), i = We(e.filter((t => t.box.fullSize)), !0), n = We(Ve(e, "left"), !0), o = We(Ve(e, "right")),
                    s = We(Ve(e, "top"), !0), a = We(Ve(e, "bottom")), r = Be(e, "x"), l = Be(e, "y");
                return {
                    fullSize: i,
    ...
    const hi = t => 0 === t || 1 === t, di = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * bt / i),
        ui = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * bt / i) + 1, fi = {
            linear: t => t,
            easeInQuad: t => t * t,
            easeOutQuad: t => -t * (t - 2),
    ...
    class Ai {
        ...
        linkScales() {
            const t = this, e = t.chart, i = t._cachedMeta, n = t.getDataset(),
                o = (t, e, i, n) => "x" === t ? e : "r" === t ? n : i, s = i.xAxisID = K(n.xAxisID, Si(e, "x")),
                a = i.yAxisID = K(n.yAxisID, Si(e, "y")), r = i.rAxisID = K(n.rAxisID, Si(e, "r")), l = i.indexAxis,
        ...
        getMinMax(t, e) {
            const i = this, n = i._cachedMeta, o = n._parsed, s = n._sorted && t === n.iScale, a = o.length,
                r = i._getOtherScale(t), l = e && n._stacked && {keys: yi(i.chart, !0), values: null},
    ...
    class ji extends Oi {
            ...
            if (a) {
                ...
                if (r ? (e.width = t.maxWidth, e.height = Wi(s) + a) : (e.height = t.maxHeight, e.width = Wi(s) + a), n.display && t.ticks.length) {
                    const {first: i, last: o, widest: s, highest: a} = t._getLabelSizes(), l = 2 * n.padding,
                        c = Rt(t.labelRotation), h = Math.cos(c), d = Math.sin(c);
                    if (r) {
        ...
        _tickSize() {
            const t = this, e = t.options.ticks, i = Rt(t.labelRotation), n = Math.abs(Math.cos(i)),
        ...
        _computeGridLineItems(t) {
            const e = this, i = e.axis, n = e.chart, o = e.options, {grid: s, position: a} = o, r = s.offset,
                l = e.isHorizontal(), c = e.ticks.length + (r ? 1 : 0), h = Wi(s), d = [],
        ...
        _computeLabelItems(t) {
            const e = this, i = e.axis, n = e.options, {position: o, ticks: s} = n, a = e.isHorizontal(),
                r = e.ticks, {align: l, crossAlign: c, padding: h} = s, d = Wi(n.grid), u = d + h,
                f = -Rt(e.labelRotation), g = [];
        ...
        drawGrid(t) {
            const e = this, i = e.options.grid, n = e.ctx, o = e.chart, s = i.setContext(e.getContext(0)),
            ...
            if (a) {
                ...
                e.isHorizontal() ? (r = Ut(o, e.left, a) - a / 2, l = Ut(o, e.right, n) + n / 2, c = d = s) : (c = Ut(o, e.top, a) - a / 2, d = Ut(o, e.bottom, n) + n / 2, r = l = s), h({
                    x: r,
                    y: c
                }, {x: l, y: d}, {width: a, color: t.borderColor})
            }
        }
    ...
    function un(t, e, i, n) {
        const o = {x: t.cp2x, y: t.cp2y}, s = {x: e.cp1x, y: e.cp1y}, a = hn(t, o, i), r = hn(o, s, i), l = hn(s, e, i),
            c = hn(a, r, i), h = hn(r, l, i);
        return hn(c, h, i)
    }
    ...
    function mn(t) {
        return "angle" === t ? {between: Wt, compare: Vt, normalize: Bt} : {
    ...
    function bn(t, e, i) {
        ...
        const {property: n, start: o, end: s} = i, a = e.length, {
            ...
            between: l,
            normalize: c
        } = mn(n), {start: h, end: d, loop: u} = function (t, e, i) {
    ...
    function An(t) {
        ...
        e.plugins = K(e.plugins, {}), e.scales = function (t, e) {
            const i = ut[t.type] || {scales: {}}, n = e.scales || {}, o = Dn(t.type, e), s = Object.create(null),
    ...
    class Yn {
        ...
        update(t) {
            ...
            e._minPadding = s, e._updateLayout(s), n || J(o, (t => {
                t.reset()
            })), e._updateDatasets(t), e.notifyPlugins("afterUpdate", {mode: t}), e._layers.sort(Vn("z", "_idx")), e._lastEvent && e._eventHandler(e._lastEvent, !0), e.render()
        }
    ...
    class eo extends Ai {
        ...
        updateElements(t, e, i, n) {
            ...
            for (let a = e; a < e + i; a++) {
                const e = s ? {base: r, head: r} : o._calculateBarValuePixels(a), i = o._calculateBarIndexPixels(a, c),
                    h = {
                        horizontal: l,
                        base: e.base,
                        x: l ? e.head : i.center,
        ...
        _calculateBarValuePixels(t) {
            const e = this, {vScale: i, _stacked: n} = e._cachedMeta, {base: o, minBarLength: s} = e.options,
                a = e.getParsed(t), r = a._custom, l = to(r);
    ...
    class no extends Ai {
        ...
        update(t) {
            const e = this, i = e.chart, {chartArea: n} = i, o = e._cachedMeta, s = o.data,
                ...
                l = Math.min(G(e.options.cutout, r), 1), c = e._getRingWeight(e.index), {
                    circumference: h,
                    rotation: d
                } = e._getRotationExtents(), {ratioX: u, ratioY: f, offsetX: g, offsetY: p} = function (t, e, i) {
                    let n = 1, o = 1, s = 0, a = 0;
                    if (e < bt) {
                        const r = t, l = r + e, c = Math.cos(r), h = Math.sin(r), d = Math.cos(l), u = Math.sin(l),
                            ...
                            m = f(Mt, h, u), x = g(xt, c, d), b = g(xt + Mt, h, u);
    ...
    class oo extends Ai {
        ...
        updateElements(t, e, i, n) {
            const o = this, s = "reset" === n, {xScale: a, yScale: r, _stacked: l} = o._cachedMeta,
                ...
                u = o.options.spanGaps, f = At(u) ? u : Number.POSITIVE_INFINITY,
                g = o.chart._animationsDisabled || s || "none" === n;
            let p = e > 0 && o.getParsed(e - 1);
            for (let c = e; c < e + i; ++c) {
                const e = t[c], i = o.getParsed(c), u = g ? e : {}, m = u.x = a.getPixelForValue(i.x, c),
    ...
    lo.id = "scatter", lo.defaults = {showLine: !1, fill: !1}, lo.overrides = {
    ...
    function fo(t, e) {
        const {x: i, y: n, startAngle: o, endAngle: s, pixelMargin: a, options: r} = e, l = e.outerRadius,
            c = e.innerRadius + a, h = "inner" === r.borderAlign;
    ...
    class go extends Oi {
        ...
        getCenterPoint(t) {
            const {
                    ...
                    innerRadius: s,
                    outerRadius: a
                } = this.getProps(["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius"], t), r = (n + o) / 2,
                l = (s + a) / 2;
    ...
    class Ro extends Oi {
        ...
        draw(t) {
            const e = this.options, {inner: i, outer: n} = Ao(this),
                        ...
                        h = function (t, e, i) {
                            ...
                            for (o[d++] = t[u], a = 0; a < n - 2; a++) {
                                ...
                                const f = Math.floor((a + 1) * s) + 1,
                                    g = Math.min(Math.floor((a + 2) * s) + 1, t.length), p = g - f;
    ...
    var Qo = {
        id: "filler", afterDatasetsUpdate(t, e, i) {
            ...
            }(o), {line: a, scale: r} = o, l = a.options, c = l.fill, h = l.backgroundColor, {
                above: d = h,
                below: u = h
            } = c || {};
    ...
    class ts extends Oi {
        ...
        fit() {
            ...
            const n = e.labels, o = Ee(n.font), s = o.size, a = t._computeTitleHeight(), {
                boxWidth: r,
                itemHeight: l
            } = Jo(n, s);
            let c, h;
        ...
        _draw() {
            const t = this, {options: e, columnSizes: i, lineWidths: n, ctx: a} = t, {align: r, labels: l} = e,
                c = mt.color, h = fn(e.rtl, t.left, t.width), d = Ee(l.font), {color: u, padding: f} = l, g = d.size,
                p = g / 2;
            let m;
            ...
            const {boxWidth: x, boxHeight: b, itemHeight: _} = Jo(l, g), y = t.isHorizontal(),
            ...
            t.legendItems.forEach(((e, u) => {
                const w = a.measureText(e.text).width, k = h.textAlign(e.textAlign || (e.textAlign = l.textAlign)),
                    S = x + g / 2 + w;
                let P = m.x, D = m.y;
    ...
    class is extends Oi {
        ...
        draw() {
            ...
            if (!i.display) return;
            const o = Ee(i.font), s = o.lineHeight / 2 + t._padding.top, {
                titleX: a,
                titleY: r,
                maxWidth: l,
                rotation: c
    ...
    function ls(t, e) {
        const i = t._chart.ctx, {body: n, footer: o, title: s} = t, {boxWidth: a, boxHeight: r} = e, l = Ee(e.bodyFont),
            c = Ee(e.titleFont), h = Ee(e.footerFont), d = s.length, u = o.length, f = n.length, g = Re(e.padding);
    ...
    class ps extends Oi {
        ...
        _resolveAnimations() {
            ...
            const i = t._chart, n = t.options.setContext(t.getContext()),
                o = n.enabled && i.options.animation && n.animations, s = new bi(t._chart, o);
        ...
        update(t, e) {
            ...
            if (o.length) {
                ...
                const e = i._size = ls(i, n), r = Object.assign({}, t, e), l = hs(i._chart, n, r),
                    c = ds(n, r, l, i._chart);
        ...
        _drawColorBox(t, e, i, n, o) {
            const s = this, a = s.labelColors[i], r = s.labelPointStyles[i], {boxHeight: l, boxWidth: c} = o,
                h = Ee(o.bodyFont), d = us(s, "left", o), u = n.x(d), f = l < h.lineHeight ? (h.lineHeight - l) / 2 : 0,
                g = e.y + f;
            if (o.usePointStyle) {
    ...
    class ys extends ji {
        ...
        handleTickRangeOptions() {
            const t = this, {beginAtZero: e, stacked: i} = t.options, {
                minDefined: n,
                maxDefined: o
            } = t.getUserBounds();
            let {min: s, max: a} = t;
    ...
    class Os extends ys {
        ...
        drawGrid() {
            ...
            if (i.pointLabels.display && function (t, e) {
                ...
                for (let o = e - 1; o >= 0; o--) {
                    const e = n.setContext(t.getContext(o)), s = Ee(e.font), {
                        x: a,
                        y: r,
                        textAlign: l,
                        left: c,
    ...
    class Vs extends ji {
        ...
        _generate() {
            const t = this, e = t._adapter, i = t.min, n = t.max, o = t.options, s = o.time,
                a = s.unit || Is(s.minUnit, i, n, t._getLabelCapacity(i)), r = K(s.stepSize, 1),
                l = "week" === a && s.isoWeekday, c = At(l) || !0 === l, h = {};
            let d, u, f = i;
        ...
        _getLabelSize(t) {
            const e = this, i = e.options.ticks, n = e.ctx.measureText(t).width,
                o = Rt(e.isHorizontal() ? i.maxRotation : i.minRotation), s = Math.cos(o), a = Math.sin(o),
        ...
        _getLabelCapacity(t) {
            const e = this, i = e.options.time, n = i.displayFormats, o = n[i.unit] || n.millisecond,
                s = e._tickFormatFunction(t, 0, zs(e, [t], e._majorUnit), o), a = e._getLabelSize(s),
