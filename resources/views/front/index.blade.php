            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide" style="background-image: url({{asset('assets/images/slide1.jpeg')}})">
                    <!-- <div class="slider-text-box">
                        <div class="slider-subtitle">Welcome to our website</div>
                        <div class="slider-title">First Slide Title</div>
                        <div class="slider-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ultricies, nunc ut auctor faucibus, purus ipsum placerat dui.</div>
                ...
                <div class="swiper-slide" style="background-image: url({{asset('assets/images/slide2.jpeg')}})">
                    <!-- <div class="slider-text-box">
                        <div class="slider-subtitle">Explore our services</div>
                        <div class="slider-title">Second Slide Title</div>
                        <div class="slider-text">Nulla facilisi. Donec rhoncus nisl vitae posuere venenatis. Vivamus non lectus eu neque volutpat finibus vel sed libero.</div>
                        <div class="slider-buttons">
                            <a href="#" class="btn btn-primary">Learn More</a>
                            <a href="#" class="btn btn-secondary">Contact Us</a>
                        </div>
