<x-front.layout>
    ...
    <div class="header-area header-sanatory"
         style="padding:50px 0px; background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url({{asset('assets/images/bannerBg.jpg')}}); background-position:center; background-size:cover;">
    ...
    <div class="donation-section-area padding-top-60 padding-bottom-60" style="background-color:whitesmoke; margin-top: 0px">
        <div class="container">
            ...
            <div class="btn-wrapper text-center margin-top-40">
                <a href="{{route('donate')}}" class="boxed-btn btn-sanatory">Donate Now</a>
            </div>
        </div>
    </div>
