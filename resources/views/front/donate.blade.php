                ...
                <div class="col-lg-8">
                    <div class="donation-form">
                        ...
                        <form id="donation-form">
                            ...
                            <label class="container-box" style="color: black; display: flex; ">
                                <input type="checkbox" id="termsAndConditionCheckbox" name="termsAndConditionCheckbox" style="display: block;margin-right: 10px; height: 20px; width: 20px">

                                By selecting, you agree to our<a href="{{route('donationTerms')}}" style="color: #b30d00;cursor: pointer; font-size: 16px; margin-left: 5px;"> Terms & Conditions</a>
                            </label>
                ...
                try {
                    const response = await fetch('/create-checkout-session', {
                        ...
                        body: JSON.stringify({
                            ...
                            terms_and_condition_checkbox: document.getElementById('termsAndConditionCheckbox').checked
                        })
                    });
