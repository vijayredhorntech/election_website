           ...
           <div class="w-full h-64 rounded-t-md relative">
            ...
            <div class="bg-white px-4 py-12 flex flex-col">
                ...
                <span class="text-gray-700 font-medium text-md mt-2">Join hundreds of thousands of party members as we fix the foundations and rebuild UK.</span>
                 <div class="py-6 w-full flex-col ">
                     <input type="email" class="w-full rounded-[3px] border-[1px] border-red-600 px-4 lg:py-3 py-2 focus:outline-none focus:ring-0 focus:border-red-700 placeholder:text-red-500" placeholder="Enter your email.....">
                    <div class="mt-4 flex gap-2 ">
                        <input type="checkbox" class="rounded-[3px] border-[1px] border-red-600  focus:outline-none focus:ring-0 focus:border-red-700 placeholder:text-red-500">
                        <label for="" class="font-semibold text-sm text-black">Currently not a member of any other party</label>
                    </div>
                 </div>
                <div class="w-full flex">
                    <a href="{{route('otpVerification')}}" class="w-full text-center bg-red-500 px-4 py-3 rounded-full text-white font-semibold hover:bg-red-700 transition ease-in duration-200 cursor-pointer">Get Started <i class="fa fa-angle-right"></i> </a>
                 </div>
