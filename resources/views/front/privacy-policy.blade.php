            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="content">
                        ...
                        <ul>
                            <li>Membership registration: Name, address, email, phone number, and payment details</li>
                            <li>Donations: Financial details (handled securely by third-party payment processors)</li>
                        ...
                        <ul>
                            ...
                            <li>Ensuring compliance with PPERA and Electoral Commission regulations</li>
