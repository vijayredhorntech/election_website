                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <input type="date" 
                                            ...
                                            class="form-control" 
                                            required>
                                        <small class="text-muted">You must be at least 16 years old to register</small>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const phonePatterns = {
        'US': { pattern: /^\d{10}$/, example: '(555) 123-4567' },
        'GB': { pattern: /^\d{10,11}$/, example: '07700 900123' },
        'IN': { pattern: /^\d{10}$/, example: '9876543210' },
        'CA': { pattern: /^\d{10}$/, example: '(416) 555-1234' },
        'AU': { pattern: /^\d{9,10}$/, example: '0412 345 678' },
    ...
    fetch('https://restcountries.com/v3.1/all?fields=name,idd,cca2,flags')
        ...
        .catch(error => {
            ...
            const fallbackCountries = [
                { cca2: 'GB', name: { common: 'United Kingdom' }, idd: { root: '+44', suffixes: [''] } },
                { cca2: 'US', name: { common: 'United States' }, idd: { root: '+1', suffixes: [''] } },
                { cca2: 'IN', name: { common: 'India' }, idd: { root: '+91', suffixes: [''] } },
                { cca2: 'CA', name: { common: 'Canada' }, idd: { root: '+1', suffixes: [''] } },
                { cca2: 'AU', name: { common: 'Australia' }, idd: { root: '+61', suffixes: [''] } }
            ];
