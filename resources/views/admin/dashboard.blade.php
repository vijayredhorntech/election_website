<x-app-layout>
        ...
        <nav>
            ...
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                ...
                <li class="text-sm pl-2 capitalize leading-normal text-black before:float-left before:pr-2 before:text-black before:content-['/']"
                    aria-current="page">Admin Dashboard
                </li>
            </ol>
            <h6 class="mb-0 font-bold text-black capitalize">Admin Dashboard</h6>
        </nav>
    @endsection
    ...
    @push('scripts')
        ...
        <script>
                ...
                options: {
                    ...
                    scales: {
                        y: {
                            ...
                            title: {
                                display: true,
                                text: 'Number of Registered Members'
                            }
                        }
                    }
                }
                ...
                options: {
                    ...
                    scales: {
                        y: {
                            ...
                            title: {
                                display: true,
                                text: 'Number of Registered Employees'
                            }
                        }
                    }
                }
            ...
            // Render both charts
            new Chart(document.getElementById('officeEmployeesChart'), officeConfig);
            new Chart(document.getElementById('constituencyMembersChart'), constituencyConfig);
            new Chart(document.getElementById('topUsersChart'), topUsersConfig);
        </script>
    @endpush
