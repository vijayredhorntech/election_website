                        ...
                        <tbody>
                            ...
                            <tr class="{{$loop->iteration%2 ===0?'bg-primaryDark/10':''}}">
                                ...
                                <td class="border-[1px] border-primaryLight/50 font-medium text-black px-4 py-1 text-sm">
                                    <a href="{{route('contact.edit',['id'=>$contact->id])}}" class="bg-info text-white px-3 py-1 rounded-[3px]" title="Edit Query"><i class="fa fa-pen text-xs"></i></a>
                                    <a href="{{route('contact.delete',['id'=>$contact->id])}}" class="bg-danger text-white px-3 py-1 rounded-[3px] ml-0.5" title="Delete Query"><i class="fa fa-trash text-xs"></i></a>
                                </td>
                            </tr>
                            @empty
                            <tr>
