<div class="flex flex-col gap-1 relative">
    ...
    <input type="text" id="constituency" name="constituency" value="{{ isset($member->constituency) ? $member->constituency : '' }}" placeholder="Enter constituency..." class="text-sm px-4 py-1.5 rounded-[3px] border-[1px] border-primaryLight/50 placeholder-black text-black focus:outline-none focus:ring-0 focus:border-primaryLight/80 transition ease-in duration-200">
    <div>
