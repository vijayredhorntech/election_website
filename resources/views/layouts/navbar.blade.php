<nav
    class="sticky top-0 z-40 relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all ease-in shadow-none duration-250 rounded-[3px] lg:flex-nowrap lg:justify-start bg-white mt-4 shadow-lg shadow-black/10"
